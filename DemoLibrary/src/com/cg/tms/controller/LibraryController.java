...
public class LibraryController
{
	...
	public String Choice(@RequestParam("option") Integer option, Model model)
	{
		...
		switch(option)
		{
			...
			case 5:{
						List<Object[]> resultList=lSer.BooksIssuedButNotReturned();
	...
	public String GetTransactionHistory1(@RequestParam("sDate") String sDate,@RequestParam("eDate") String eDate, Model model)
	{		
