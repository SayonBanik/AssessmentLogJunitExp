...
public class LibraryDaoImpl implements LibraryDao
{
	...
	@Override
	public List<Object[]> BooksIssuesButNotReturned()
	{
		//String jpql="SELECT b.bkId,b.bkTitle,b.bkQty,b.bkEdition,b.bkCost,t.txnId,t.returnStatus FROM Book b,LibTransaction t WHERE b.bkId=t.bId AND t.returnStatus='Not Returned'";
		
		String jpql="SELECT b.bkId,t.txnId FROM Book b,LibTransaction t WHERE b.bkId=t.bId";
